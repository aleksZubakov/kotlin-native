...
interface DescriptorComparator<T : DeclarationDescriptor> {
    fun compare(o1: T, o2: T): ComparisonResult
}
...
//class ValueDescriptorComparator(val intersector: DummyIntersector) : DescriptorComparator {
//    companion object {
...
//        }
//
//        val res = intersector.intersect(o1.constructor.declarationDescriptor!!, o2.constructor.declarationDescriptor!!)
...
//class FunctionDescriptorComparator(val intersector: DummyIntersector) : DescriptorComparator {
//    companion object {
////        val INSTANCE = FunctionDescriptorComparator()
//    }
//
//    val valueDescriptorComparator = ValueDescriptorComparator(intersector)
//
//    override fun compare(o1: DeclarationDescriptor, o2: DeclarationDescriptor): ComparisonResult {
...
//                    (o1.isSuspend == o2.isSuspend).toResult(Suspend) and
//                    (compareTypes(o1.returnType!!, o2.returnType!!)).toResult(Type) and
...
//class ClassDescriptorComparator(val intersector: DummyIntersector) : DescriptorComparator {
//    companion object {
